...
class SearchScreen extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Sync controller dengan state jika di-set dari luar (tap suggestion)
    useEffect(() {
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            // ─── Tab filter (hanya tampil saat ada hasil) ─────
            if (state.hasResults)
              _TabBar(
          ...
          if (hasQuery) ...[
            ...
            TextButton(
              ...
              style: TextButton.styleFrom(
                foregroundColor: const Color(0xFF3F7AF6),
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isActive ? const Color(0xFF3F7AF6) : const Color(0xFF12121E),
          borderRadius: BorderRadius.circular(20),
          border: Border.all(
            color: isActive ? const Color(0xFF3F7AF6) : const Color(0xFF1E1E2E),
          ),
        ),
        child: Text(
          label,
...
class _Body extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Belum search — tampilkan discovery
    return _Discovery(
    ...
    return CustomScrollView(
      slivers: [
        ...
        if ((tab == SearchTab.all || tab == SearchTab.tags) &&
          ...
          if (tab == SearchTab.all) _SliverHeader('Tag', results.tags.length),
          SliverToBoxAdapter(
            child: Padding(
...
class _ArticleCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return GestureDetector(
      onTap: () {
        ...
        // Perlu fetch full ArticleModel atau gunakan route by ID
        context.push('/article/${article.id}', extra: _toArticleModel(article));
      },
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(14),
          border: Border.all(color: const Color(0xFF1A1A2A), width: 0.5),
        ),
        child: Row(
          children: [
            // Thumbnail
  ...
  Widget _thumbPlaceholder(double size) => Container(
    ...
    child: const Icon(Icons.image_outlined, color: Color(0xFF2D2D4A), size: 24),
  );

  // Konversi ke ArticleModel minimal untuk navigasi
  ArticleModel _toArticleModel(ArticleResult a) {
    return ArticleModel(
      id: a.id,
      authorId: '',
      ...
      estimatedReading: a.estimatedReading,
                ...
                Row(
                  children: [
                    ...
                    if (user.followersCount > 0) ...[
                      ...
                      Text(
                        '${_fmtCount(user.followersCount)} pengikut',
                        style: const TextStyle(
                          color: Color(0xFF6B7280),
                          fontSize: 12,
                        ),
        ...
        child: Row(
          ...
          children: [
            ...
            if (tag.articleCount > 0) ...[
              ...
              Text(
                '${tag.articleCount}',
                style: const TextStyle(color: Color(0xFF2D5282), fontSize: 11),
              ),
            ],
          ],
        ),
